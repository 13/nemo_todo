...
@JsonKey(name: 'task_id') String get parentId;/// Lowercase hex SHA-256 of the processed bytes.
 String get sha256; int get byteSize; int get width; int get height; String get sortKey; String get updatedAt;/// Absent on the wire from a client or server released before notes,
/// where it could only ever have meant a task.
 PhotoParent get parentKind; String? get deletedAt;
...
int get hashCode {
  final _this = this as Photo;
  return Object.hash(runtimeType,_this.id,_this.parentId,_this.sha256,_this.byteSize,_this.width,_this.height,_this.sortKey,_this.updatedAt,_this.parentKind,_this.deletedAt);
}

@override
String toString() {
  final _this = this as Photo;
  return 'Photo(id: ${_this.id}, parentId: ${_this.parentId}, sha256: ${_this.sha256}, byteSize: ${_this.byteSize}, width: ${_this.width}, height: ${_this.height}, sortKey: ${_this.sortKey}, updatedAt: ${_this.updatedAt}, parentKind: ${_this.parentKind}, deletedAt: ${_this.deletedAt})';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'task_id') String parentId, String sha256, int byteSize, int width, int height, String sortKey, String updatedAt, PhotoParent parentKind, String? deletedAt
});
...
/// Create a copy of Photo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? parentId = null,Object? sha256 = null,Object? byteSize = null,Object? width = null,Object? height = null,Object? sortKey = null,Object? updatedAt = null,Object? parentKind = null,Object? deletedAt = freezed,}) {
  return _then(Photo(
...
as PhotoParent,deletedAt: freezed == deletedAt ? _self.deletedAt : deletedAt // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'task_id')  String parentId,  String sha256,  int byteSize,  int width,  int height,  String sortKey,  String updatedAt,  PhotoParent parentKind,  String? deletedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Photo() when $default != null:
return $default(_that.id,_that.parentId,_that.sha256,_that.byteSize,_that.width,_that.height,_that.sortKey,_that.updatedAt,_that.parentKind,_that.deletedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'task_id')  String parentId,  String sha256,  int byteSize,  int width,  int height,  String sortKey,  String updatedAt,  PhotoParent parentKind,  String? deletedAt)  $default,) {final _that = this;
switch (_that) {
case _Photo():
return $default(_that.id,_that.parentId,_that.sha256,_that.byteSize,_that.width,_that.height,_that.sortKey,_that.updatedAt,_that.parentKind,_that.deletedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'task_id')  String parentId,  String sha256,  int byteSize,  int width,  int height,  String sortKey,  String updatedAt,  PhotoParent parentKind,  String? deletedAt)?  $default,) {final _that = this;
switch (_that) {
case _Photo() when $default != null:
return $default(_that.id,_that.parentId,_that.sha256,_that.byteSize,_that.width,_that.height,_that.sortKey,_that.updatedAt,_that.parentKind,_that.deletedAt);case _:
  return null;
...
class _Photo extends Photo {
  const _Photo({required this.id, @JsonKey(name: 'task_id') required this.parentId, required this.sha256, required this.byteSize, required this.width, required this.height, required this.sortKey, required this.updatedAt, this.parentKind = PhotoParent.task, this.deletedAt}): super._();
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,parentId,sha256,byteSize,width,height,sortKey,updatedAt,parentKind,deletedAt);
}

@override
String toString() {
    return 'Photo(id: $id, parentId: $parentId, sha256: $sha256, byteSize: $byteSize, width: $width, height: $height, sortKey: $sortKey, updatedAt: $updatedAt, parentKind: $parentKind, deletedAt: $deletedAt)';
}
...
/// Create a copy of Photo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? parentId = null,Object? sha256 = null,Object? byteSize = null,Object? width = null,Object? height = null,Object? sortKey = null,Object? updatedAt = null,Object? parentKind = null,Object? deletedAt = freezed,}) {
  return _then(_Photo(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,parentId: null == parentId ? _self.parentId : parentId // ignore: cast_nullable_to_non_nullable
as String,sha256: null == sha256 ? _self.sha256 : sha256 // ignore: cast_nullable_to_non_nullable

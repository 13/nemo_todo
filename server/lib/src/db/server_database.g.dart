...
class $$NotesTableFilterComposer
    extends Composer<_$ServerDatabase, $NotesTable> {
...
class $$NotesTableTableManager
    extends
        RootTableManager<
          ...
          (Note, BaseReferences<_$ServerDatabase, $NotesTable, Note>),
          Note,
          PrefetchHooks Function()
        > {
  $$NotesTableTableManager(_$ServerDatabase db, $NotesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  ...
                  BaseReferences<_$ServerDatabase, $NotesTable, Note>(
                    db,
                    table,
                    e,
                  ),
